...
<gameSystem id="e820-fa69-d550-8b3f" name="Warhammer 40K 10ª por Jose Antonio" revision="5" battleScribeVersion="2.03" authorName="Jose Antonio" authorContact="Jag" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <costTypes>
    <costType id="a9a9-2915-69f6-d947" name=" Pts" defaultCostLimit="-1.0" hidden="false"/>
  </costTypes>
  <profileTypes>
    <profileType id="c2c6-a46d-ef42-f715" name="Unidad">
      <characteristicTypes>
    ...
    <profileType id="b138-5f8b-dbca-bdab" name="🧿 Armas a distancia">
      <characteristicTypes>
    ...
    <profileType id="1bda-9ac8-4f3f-5644" name="⚔️ Armas CaC">
      <characteristicTypes>
    ...
    <profileType id="2f0b-fc03-aa60-1ff6" name="Estratagemas">
      <characteristicTypes>
  ...
  <categoryEntries>
    ...
    <categoryEntry id="4e04-9580-80a3-c208" name="Fuego rapido" hidden="false">
      <infoLinks>
        <infoLink id="6371-1543-ea51-bcc6" name="Fuego Rapido X" hidden="false" targetId="8140-4fc4-068b-577a" type="rule"/>
      </infoLinks>
    </categoryEntry>
    ...
    <categoryEntry id="8817-a6a5-3854-ce14" name="Acoplado" hidden="false">
      <infoLinks>
        <infoLink id="22b4-d8f5-af24-36bf" name="Acoplada" hidden="false" targetId="042d-9db6-b697-cf0e" type="rule"/>
      </infoLinks>
    </categoryEntry>
    ...
    <categoryEntry id="84be-fa65-0ea2-9efb" name="Impactos Letales" hidden="false">
      <infoLinks>
        <infoLink id="7c2b-bd07-b237-42ca" name="Heridas letales" hidden="false" targetId="634d-3da3-1d2a-4bf9" type="rule"/>
      </infoLinks>
    </categoryEntry>
    ...
    <categoryEntry id="91b7-3c00-dab8-836c" name="Rafaga" hidden="false">
      <infoLinks>
        <infoLink id="2d12-11e9-b4a1-2376" name="Torrente" hidden="false" targetId="0823-2a8e-0584-d12c" type="rule"/>
      </infoLinks>
    </categoryEntry>
    ...
    <categoryEntry id="eb58-b5bf-030f-1beb" name="Ataques adicionales" hidden="false">
      <infoLinks>
        <infoLink id="bc7f-0517-ad0a-3953" name="Ataques extra X" hidden="false" targetId="b2fb-d160-b2fb-3540" type="rule"/>
      </infoLinks>
    </categoryEntry>
    ...
    <categoryEntry id="72c0-4f1b-c92d-7b34" name="Infiltración" hidden="false">
      <infoLinks>
        <infoLink id="3ac0-c9e0-ed8b-9a37" name="Infiltracion" hidden="false" targetId="2d5a-6a84-152f-7cb4" type="rule"/>
      </infoLinks>
    </categoryEntry>
    ...
    <categoryEntry id="1227-47da-963c-7ae4" name="Cubierta de disparo X" hidden="false">
      <rules>
        <rule id="f4f6-ec18-4902-20a0" name="Cubierta de disparo X" hidden="false">
          <description>
■ Cubierta de disparo x+: Cuando este 
...
también equipado con dichas armas</description>
    ...
    <categoryEntry id="8b79-15f1-01dc-4e89" name="Final violento" hidden="false">
      <infoLinks>
        <infoLink id="4bc2-ab9c-43cc-02a4" name="Final violento X" hidden="false" targetId="a947-d4b5-7f7e-c9a0" type="rule"/>
      </infoLinks>
    </categoryEntry>
    <categoryEntry id="23bb-d76b-d74a-d380" name="Líder" hidden="false">
      <infoLinks>
        <infoLink id="71bf-c906-90b3-e6f3" name="Lider" hidden="false" targetId="5c0b-b2b5-e953-0f2b" type="rule"/>
      </infoLinks>
    </categoryEntry>
    ...
    <categoryEntry id="2b13-b24e-d331-227c" name="Señor de la Guerra" hidden="false">
      <constraints>
        <constraint field="selections" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" id="ac74-7c60-8518-192c" type="min"/>
        <constraint field="selections" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="true" includeChildForces="true" id="daeb-8d29-1454-64a2" type="max"/>
      </constraints>
    </categoryEntry>
    ...
    <forceEntry id="8696-0000-0cac-6116" name="Ejercito Imperio T&apos;au" hidden="false">
      ...
      <categoryLinks>
        ...
        <categoryLink id="d1d1-4dfe-a38d-6380" name="Cuartel General" hidden="false" targetId="9d48-1013-e052-2c37" primary="false">
          <constraints>
            <constraint field="selections" scope="roster" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="a43e-9f02-46bc-2aa7" type="min"/>
          </constraints>
        </categoryLink>
        ...
        <categoryLink id="4b81-78d6-c688-ea45" name="Legens" hidden="false" targetId="584a-6bca-a178-ecdc" primary="false"/>
  ...
  <sharedRules>
    <rule id="8140-4fc4-068b-577a" name="Fuego rapido" hidden="false">
      <description>
■ [FUEGO RÁPIDO X]: Aumenta en &quot;X&quot; los Ataques al disparar a unidades a la mitad de su alcance o más cerca.</description>
    </rule>
    <rule id="1d0b-4c2a-64ce-1e1a" name="Golpes sostenidos X" hidden="false">
      <description>
■ [GOLPES SOSTENIDOS X]: Cada impacto crítico logra “X” impactos adicionales contra el blanco.</description>
    </rule>
    <rule id="872e-1f24-bcfc-461e" name="Fusion X" hidden="false">
      <description>
■ [FUSIÓN X]: Aumenta el Daño en “X” al atacar a unidades a la mitad de alcance o más cerca.</description>
    </rule>
    <rule id="042d-9db6-b697-cf0e" name="Acoplado" hidden="false">
      <description>
■ Las armas con [ACOPLADA] en su perfil se denominan armas Acopladas. Al atacar con esas armas, puedes repetir la tirada para herir de dicho ataque.</description>
    </rule>
    <rule id="38ab-bb43-7a63-942f" name="Heridas devastadoras" hidden="false">
      <description>
■ Cada herida crítica inflige tantas heridas mortales como el atributo Daño, en lugar de infligir daño normal.</description>
    </rule>
    <rule id="547f-8c08-ba1d-297f" name="Ignora cobertura" hidden="false">
      <description>
■ Las armas con [IGNORA COBERTURA] en su perfil se denominan armas que Ignoran cobertura. Al atacar con estas armas, el blanco no puede beneficiarse de cobertura contra dicho ataque.</description>
    </rule>
    <rule id="0823-2a8e-0584-d12c" name="Rafaga" hidden="false">
      <description>
■ Las armas con [RÁFAGA] en su perfil se denominan armas de Ráfaga. Al atacar con esas armas, el ataque impacta automáticamente al blanco.</description>
    </rule>
    <rule id="b639-0066-b742-3dae" name="Un solo uso" hidden="false">
      <description>
■ Este arma solo puede dispararse una sola vez por batalla.</description>
    </rule>
    <rule id="2853-2beb-c306-d44d" name="Pistola" hidden="false">
      <description>
■ Pueden dispararse incluso si la unidad del portador tiene unidades enemigas en su zona de amenaza, pero en tal caso debe elegir como blanco a una de dichas unidades enemigas.
■ No pueden dispararse a la vez que otras armas que no sean Pistolas (salvo si el atacante es un Monstruo o Vehículo).</description>
    ...
    <rule id="634d-3da3-1d2a-4bf9" name="Impactos letales" hidden="false">
      <description>
■ Las armas con [IMPACTOS LETALES] en su perfil se denominan armas de Impactos letales. Al atacar con esa arma, un impacto crítico hiere al blanco automáticamente.</description>
    </rule>
    <rule id="00ab-6a5f-d8f6-d41d" name="Pesada" hidden="false">
      <description>
■ Suma 1 a la tirada para impactar si la unidad del portador ha permanecido inmóvil este turno.
</description>
    </rule>
    <rule id="5901-b479-1835-ce9e" name="Asalto" hidden="false">
      <description>
■ Puede dispararse incluso si la unidad del portador ha avanzado.</description>
    </rule>
    <rule id="2e2f-3e7d-d033-a157" name="Anti- X" hidden="false">
      <description>
■ [ANTI]: Una tirada para herir de “X+” sin modificar contra un blanco que tenga la clave indicada causa una herida crítica.</description>
    </rule>
    <rule id="88c4-0a37-8c2c-9d23" name="Lanza" hidden="false">
      <description>
■ Las armas con [LANZA] en su perfil se denominan Lanzas. Al atacar con esas armas, si el portador ha cargado este turno, suma 1 a la tirada para herir de dicho ataque.</description>
    </rule>
    <rule id="2710-3382-4a85-d4f1" name="Precision" hidden="false">
      <description>
■ Al elegir como blanco a una unidad adjunta, el jugador de la miniatura atacante puede asignar el ataque a una miniatura Personaje de esa unidad que sea visible para el portador del arma.</description>
    </rule>
    <rule id="cd10-878b-4a6d-a567" name="Area" hidden="false">
      <description>
■ Suma 1 al atributo Ataques por cada cinco miniaturas que haya en la unidad blanco (redondeando a la baja).
■ No pueden usarse contra un blanco en la zona de amenaza de alguna unidad del ejército de la miniatura atacante (incluyendo la suya propia).</description>
    ...
    <rule id="b2fb-d160-b2fb-3540" name="Ataques adicionales" hidden="false">
      <description>
■ El portador puede atacar con esta arma además de con cualquier otra arma con la que pueda atacar.
■ El número de esos ataques adicionales no puede modificarse.</description>
    ...
    <rule id="cd70-428a-f04d-2635" name="De riesgo" hidden="false">
      <description>
■ Después de que una unidad dispare, haz un chequeo de riesgo con 1D6 por cada arma De riesgo disparada. Por cada 1, una miniatura equipada con un arma De riesgo es eliminada (Personajes, Monstruos y Vehículos sufren 3 heridas mortales en su lugar). </description>
    </rule>
    <rule id="b8f1-e45c-7771-58fd" name="Avanzadilla" hidden="false">
      <description>
■ Avanzadilla x&quot;: La unidad puede hacer un movimiento normal de hasta x&quot; antes del primer turno.
...
■ El movimiento debe terminar a más de 9&quot; en horizontal de toda miniatura enemiga.</description>
    ...
    <rule id="2d5a-6a84-152f-7cb4" name="Infiltración" hidden="false">
      <description>
■ Durante el despliegue, si cada miniatura de una unidad tiene esta habilidad, cuando la despliegues puedes colocarla en cualquier punto del campo de batalla que esté a más de 9&quot; en horizontal de la zona de despliegue enemiga y de toda miniatura enemiga.</description>
    </rule>
    <rule id="1fc0-aa2b-2403-a94d" name="Sigilo" hidden="false">
      <description>
■ Si todas las miniaturas de una unidad tienen esta habilidad, resta 1 a las tiradas para impactar de los ataques a distancia contra dicha unidad.</description>
    </rule>
    <rule id="ac81-703e-c70d-1415" name="Indirecta" hidden="false">
      <description>
■ Puede elegir como blanco y atacar a unidades que no son visibles para la unidad atacante.
■ Si ninguna miniatura es visible para la unidad blanco cuando esta es elegida, al atacar a ese blanco con un arma Indirecta restas 1 a la tirada para impactar y el blanco se beneficia de cobertura contra dicho ataque.</description>
    ...
    <rule id="a08e-a31d-53b9-0372" name="Despliegue rapido" hidden="false">
      <description>
■ La unidad puede desplegarse en la reserva en lugar de en el campo de batalla.
■ La unidad puede ser desplegada en tu paso de refuerzos, a más de 9&quot; en horizontal de toda miniatura enemiga.</description>
    ...
    <rule id="fe63-0852-98a8-eee2" name="No hay dolor" hidden="false">
      <description>
■ No hay dolor x+: Cada vez que esta miniatura vaya a perder una herida, tira 1D6: si el resultado es igual o mayor que x, no pierde esa herida.</description>
    </rule>
    <rule id="a947-d4b5-7f7e-c9a0" name="Final violento" hidden="false">
      <description>
■ Final violento x: Cuando esta miniatura es eliminada tira 1D6. Con un 6, cada unidad a 6&quot; o menos de ella sufre x heridas mortales.</description>
    </rule>
    <rule id="2d1d-d49c-e5e8-a529" name="Copmbatir primero" hidden="false">
      <description>
■ Si una unidad con esta habilidad puede ser elegidas para combatir, lo hará en el paso de Combatir primero, siempre que todas sus miniaturas tengan esta habilidad.</description>
    </rule>
    <rule id="b1ed-47d2-f43b-feab" name="Aeronave" hidden="false">
      <description>
■ Las Aeronaves solo pueden llevar a cabo un movimiento normal, y pueden hacerlo aunque haya miniaturas enemigas en su zona de amenaza.
...
■ Las Aeronaves que salen del borde del campo de batalla, o que no pueden llevar a cabo su movimiento mínimo, se colocan en la reserva estratégica.</description>
    ...
    <rule id="2f89-1b0c-d4b2-4f87" name="Planeador" hidden="false">
      <description>
■ Algunas miniaturas Aeronave tienen Planeador listado entre sus habilidades. Cuando se te indique que debes Declarar formación de batalla, antes de hacer nada más deberás declarar qué miniaturas de tu ejército con esta habilidad están en modo Planeador. Si una miniatura está en modo Planeador, hasta 
...
11. DETERMINAR VECEDOR</description>
    ...
    <rule id="f677-107b-3ff1-308b" name="Cubierta de disparo X" hidden="false">
      <description>
■ Cubierta de disparo x+: Cuando este Transporte dispara, eliges un arma de hasta x miniaturas embarcadas en él; se considera que el Transporte está 
también equipado con dichas armas.</description>
    </rule>
    <rule id="5c0b-b2b5-e953-0f2b" name="Líder" hidden="false">
      <description>
■ Antes de la batalla, las unidades Personaje con la habilidad Líder pueden adjuntarse a una unidad Guardaespaldas para formar una unidad adjunta.
...
■ No pueden asignarse ataques a miniaturas Personaje de unidades adjuntas</description>
    ...
    <rule id="53fc-81d4-c25a-7458" name="Agente solitario" hidden="false">
      <description>
■ A menos que sea parte de una unidad adjunta, esta unidad solo puede ser elegida como blanco de un ataque a distancia si la miniatura atacante está a 12&quot; o menos.</description>
    </rule>
